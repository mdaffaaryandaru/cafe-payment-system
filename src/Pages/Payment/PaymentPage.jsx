...
const PaymentPage = () => {
    ...
    return (
        <section className='container'>
            <h1 className='text-4xl font-bold my-5'>Selesaikan Pembayaran</h1>
            ...
            <div className="grid grid-cols-2 gap-5">
                <div className="h-max grid grid-cols-2 gap-6">
                    {cart.map((item, i) => {
                        ...
                        return (
                            <div key={i} className="flex gap-3 bg-slate-800 p-2">
                                <img className='w-20 h-20 object-cover rounded' src={`http://10.10.10.46:3000/menu/images/${menu.gambarMenu}`} alt={menu.namaMenu} />
